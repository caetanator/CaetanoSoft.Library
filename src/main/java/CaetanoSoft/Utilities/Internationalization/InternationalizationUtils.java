...
/**
 * This class manages the translation of the Java AWT/Swing UI widgets like the
 * dialogues for Color Chooser and Load and Save.
 * <p>
 * </p>
 * For now, only the Portuguese (Portugal) language is supported.
 *
...
public class InternationalizationUtils {
  ...
  /**
   * Translate the Java default system resources strings from english to a
   * diferent language.
   * <p>
   * </p>
   ...
   *   <li> <b>en_AU</b> / <b>en-AU</b>: English (Australia)</li>
   *   <li> <b>en_NZ</b> / <b>en-NZ</b>: English (New Zealand)</li>
   *   <li> <b>en_ZA</b> / <b>en-ZA</b>: English (South Africa)</li>
   ...
   * @return  <code>true</code>, if translation was made. <code>false</code>,
   * otherwise.
   */
  public static boolean translateJavaDefaultResources(String strLang) {
    ...
    if (strLang != null && !(strLang.isBlank())) {
      ...
      switch (strLang) {
        ...
        case "en_ZA":
        case "en-ZA":       
          // Default Java resources language (English)
          strResorceLang = null;
          bRet = true;
          break;
        ...
        case "pt_BR":
        case "pt-BR":
          // Portuguese Java resources language (Portuguese)
      ...
      if (strResorceLang != null) {
        // String with the path to the translated resourses
